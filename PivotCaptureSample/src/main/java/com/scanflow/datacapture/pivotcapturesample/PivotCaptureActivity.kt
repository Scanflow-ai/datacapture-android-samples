package com.scanflow.datacapture.pivotcapturesample
...
import com.scanflow.datacapture.pivotcapturesample.databinding.ActivityPivotCaptureBinding
import com.scanflow.datacapture.utils.PermissionUtils

class PivotCaptureActivity : AppCompatActivity() {

    lateinit var binding: ActivityPivotCaptureBinding
    ...
    companion object {
        ...
        private const val TAG = "PivotCaptureActivity"
        private const val CAMERA_PERMISSION_REQUEST_CODE = 100
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_pivot_capture)
...
//           setIsContinuousScan(isContinuousScan) //by default true
        }
    }
    ...
    private val barCodeResultCallBack: ScanflowReader.OnBarcodeScanResultCallback =
        object : ScanflowReader.OnBarcodeScanResultCallback {
            ...
            override fun onScanResultSuccess(result: ScanResultSuccess) {
                ...
                runOnUiThread {
                    Toast.makeText(this@PivotCaptureActivity, result.text, Toast.LENGTH_SHORT).show()
                }
            }
        }
