package com.scanflow.datacapture.oneofmanycapturesample
...
import com.scanflow.datacapture.oneofmanycapturesample.databinding.ActivityOneOfManyScanBinding
import com.scanflow.datacapture.utils.PermissionUtils

class OneOfManyScanActivity : AppCompatActivity() {

    private lateinit var binding: ActivityOneOfManyScanBinding
    ...
    companion object {
        ...
        private const val TAG = "OneOfManyScanActivity"
        private const val CAMERA_PERMISSION_REQUEST_CODE = 100
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_one_of_many_scan)
    ...
    private val barCodeResultCallBack: ScanflowReader.OnBarcodeScanResultCallback =
        object : ScanflowReader.OnBarcodeScanResultCallback {
            ...
            override fun onOneOfManyCodeResult(results: HashSet<OneOFManyCodesScanResults>) {
                ...
                scannedDataList = hashSetOf()//clearing old values.

                results.forEach {
                    scannedDataList.add(it.decodedFormat + " : " + it.decodedValue)
                }

                runOnUiThread {
                    Toast.makeText(
                        this@OneOfManyScanActivity,
