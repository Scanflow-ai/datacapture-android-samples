...
import com.scanflow.datacapture.barcodecapturesample.databinding.ActivityAnycodeBinding
...
class AnyScanActivity : AppCompatActivity() {

    lateinit var binding: ActivityAnycodeBinding
    ...
    companion object {
        ...
        private const val TAG = "AnyScanActivity"
        private const val CAMERA_PERMISSION_REQUEST_CODE = 100
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_anycode)
    ...
    private val barCodeResultCallBack: ScanflowReader.OnBarcodeScanResultCallback =
        object : ScanflowReader.OnBarcodeScanResultCallback {
            ...
            override fun onScanResultSuccess(result: ScanResultSuccess) {
                ...
                runOnUiThread {
                    Toast.makeText(this@AnyScanActivity, result.text, Toast.LENGTH_SHORT).show()
                }
            }
        }
